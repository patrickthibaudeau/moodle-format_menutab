            ...
            init: function (pageType) {
                $(document).ready(function () {
                    ...
                    Templates.render("format_menutab/colour_picker", {
                        colours: sectionZeroBackgorundHeaderMenu.find("option").map(
                            function (index, option) {
                                ...
                                return {
                                    ...
                                    id: colour.replace("#", "") + "_section_zero",
                                    section: "section_zero_background"
                                };
                            }
                        ).toArray()
                    }).done(function (html) {
                        ...
                        var section = $(".section_zero_background");
                        ...
                        sectionZeroBackgorundHeaderMenu.change(function () {
                            section.removeClass("selected");
                            $("#colourpick_" + sectionZeroBackgorundHeaderMenu.val().replace("#", "")+ "_section_zero").addClass("selected");
                        });
