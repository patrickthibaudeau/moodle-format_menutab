...
$string['tab_background_color'] = 'Tab background colors';
$string['tab_background_color_help'] = 'Enter a color per line. Each color must use the hex value of the color seperated by a pipe (|) followed by the name of the color.';
